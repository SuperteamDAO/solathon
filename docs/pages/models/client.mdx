...
- [get_highest_snapshot_slot](#get_highest_snapshot_slot)
- [get_identity](#get_identity)
- [get_inflation_governer](#get_inflation_governer)
...
- [get_stake_activation](#get_stake_activation) -->
...
<Code>
```python 
def get_blocks(start_slot: int, end_slot: Optional[int] = None)
```
</Code>
