...
### ✨ Easy to use
Using object-oriented approach, Solathon makes everything easy to understand and work with. The documentation has detailed explaination with examples for everything to get anyone started quickly.
